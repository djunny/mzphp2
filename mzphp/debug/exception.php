...
.mzphpcont h1,.mzphpcont ul,.mzphpcont ul li,.mzphpcont ul li span,.mzphpcont ul table tr td{font:14px/1.6 'Microsoft YaHei',Verdana,Arial,sans-serif}
.mzphpcont{width:98%;margin:8px auto;overflow:hidden;color:#000;border-radius:5px;box-shadow:0 0 20px #555;background:#fff;min-width:300px}
.mzphpcont h1{font-size:18px;height:26px;line-height:26px;padding:10px 3px 0;border-bottom:1px solid #dbdbdb;font-weight:700}
.mzphpcont ul,.mzphpcont h1{width:98%;margin:0 auto;overflow:hidden}
.mzphpcont ul{list-style:none;padding:3px;word-break:break-all}
.mzphpcont ul li,.mzphpcont ul table tr td{padding:0 3px}
.mzphpcont ul li span{float:left;display:inline;width:70px}
.mzphpcont ul li.even{background:#ddd}
.mzphpcont .fo{border-top:1px solid #dbdbdb;padding:5px 3px 10px;color:#666;text-align:right}
</style>
</head>
